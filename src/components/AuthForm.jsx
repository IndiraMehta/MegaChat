        ...
        <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isLogin ? 'Sign in to continue to your chat' : 'Join the conversation today'}
            </p>
          </div>
          ...
          <button
            ...
            className="w-full mb-6 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 py-3 px-4 rounded-lg font-semibold flex items-center justify-center space-x-3 transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          >
